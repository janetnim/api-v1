...
def create_app(environment = "DEVELOPMENT"):
	...
	api.add_resource(models.AdminApproveRequest, '/api/v2/requests/approve', methods=['GET'])
	api.add_resource(models.AdminRejectRequest, '/api/v2/requests/disapprove', methods=['GET'])
	api.add_resource(models.AdminResolveRequests, '/api/v2/requests/resolve', methods=['GET'])
