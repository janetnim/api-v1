...
api.add_resource(ViewAllRequest, '/users/requests/<int:personal_id>', methods=['GET'])
api.add_resource(RequestView, '/users/requests/<int:request_id>/<int:personal_id>', methods=['GET'])
api.add_resource(ModifyRequest, '/users/requests/<int:request_id>/<int:personal_id>', methods=['PUT'])
api.add_resource(DeleteRequest, '/users/requests/<int:request_id>/<int:personal_id>', methods=['DELETE'])
